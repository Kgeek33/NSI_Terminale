...
def compte_feuille (arbre):
  ...
  if not Noeud.est_vide(arbre.gauche()):
    n += compte_feuille(arbre.gauche())
  if not Noeud.est_vide(arbre.droit()):
    n += compte_feuille(arbre.droit())
  return n
...
if __name__ == '__main__' :
    ...
    A3=Noeud(3,Noeud(1,Noeud(1,Noeud.arbre_vide,Noeud.arbre_vide),Noeud.arbre_vide),Noeud(4,Noeud(5,Noeud.arbre_vide,Noeud.arbre_vide),Noeud(9,Noeud.arbre_vide,Noeud.arbre_vide)))
    print("A3=",A3)
    ...
    print("nb de feuilles de A1, A2, A3 : {}, {}, {}".format(compte_feuille(A1),compte_feuille(A2),compte_feuille(A3)))
    print("taille de A1, A2, A3 : {}, {}, {}".format(taille(A1),taille(A2),taille(A3)))
    print("hauteur de A1, A2, A3 : {}, {}, {}".format(hauteur(A1),hauteur(A2),hauteur(A3)))
