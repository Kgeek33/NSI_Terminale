...
g_regions.ajouter_arete("Centre-Val de Loire", "Pays de la Loire")
g_regions.ajouter_arete("Centre-Val de Loire", "Normandie")
g_regions.ajouter_arete("Centre-Val de Loire", "Île-de-France")
g_regions.ajouter_arete("Centre-Val de Loire", "Auvergne-Rhône-Alpes")
g_regions.ajouter_arete("Centre-Val de Loire", "Bougone-Franche-Comte")
g_regions.ajouter_arete("Pays de la Loire", "Normandie")
g_regions.ajouter_arete("Pays de la Loire", "Bretagne")
g_regions.ajouter_arete("Bretagne", "Normandie")
g_regions.ajouter_arete("Normandie", "Île-de-France")
g_regions.ajouter_arete("Normandie", "Hauts de-France")
g_regions.ajouter_arete("Hauts de-France", "Grand Est")
g_regions.ajouter_arete("Hauts de-France", "Île-de-France")
g_regions.ajouter_arete("Île-de-France", "Grand Est")
g_regions.ajouter_arete("Île-de-France", "Bougone-Franche-Comte")
g_regions.ajouter_arete("Bougone-Franche-Comte", "Grand Est")
g_regions.ajouter_arete("Bougone-Franche-Comte", "Auvergne-Rhône-Alpes")
g_regions.ajouter_arete("Auvergne-Rhône-Alpes", "Provence-Ales-Côte-d'Azure")
g_regions.ajouter_arete("Provence-Ales-Côte-d'Azure", "Occitanie")
g_regions.ajouter_arete("Nouvelle-Aquitaine", "Occitanie")
g_regions.ajouter_arete("Occitanie", "Auvergne-Rhône-Alpes")
