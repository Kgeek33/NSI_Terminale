...
def min_exclu(voisins, coloriage):
    ...
    prend en paramêtre la liste des voisins du sommet et le coloriage en
    construction,
...
def colorier(g):
    ...
    renvoie le dctionnaire des couleurs (valeur) associées à chaque sommet (
    clé),
...
g_regions.affiche()
print("{} régions, {} arêtes".format(g_regions.ordre(), int(nb_arcs_db_sens
                                                            (g_regions))))
