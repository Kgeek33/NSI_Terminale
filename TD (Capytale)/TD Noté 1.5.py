# regroupement des 2 class effectuées des TD 1.1 et TD 1.2
from domino_jeu import Domino, Joueur
import random
...
class Jeu_Domino:
    ...
    def distribuer(self, nb_joueurs):
        """
        construit le jeu de chaque joueur
        en prélevant chaque pièce dans la pioche.
        """
