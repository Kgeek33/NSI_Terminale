...
lancer1 = lancer(5)
print("Liste 1 :", lancer1,
      ". Contient le nombre 6 au moins 2 fois ? ->", paire_6(lancer1))
lancer2 = lancer(5)
print("Liste 2 :", lancer2,
      ". Contient le nombre 6 au moins 2 fois ? ->", paire_6(lancer2))
lancer3 = lancer(3)
print("Liste 3 :", lancer3,
      ". Contient le nombre 6 au moins 2 fois ? ->", paire_6(lancer3))
lancer4 = lancer(0)
print("Liste 4 :", lancer4,
      ". Contient le nombre 6 au moins 2 fois ? ->", paire_6(lancer4))
