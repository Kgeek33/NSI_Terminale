...
# si 0<=x<largeur et 0<=y<hauteur, la couleur du pixel (x,y)
# est donnée par px[x,y]
px = img.load()
# on peut modifier la couleur d'un pixel (x,y) avec l'affectation px[x,y]=c
# où c est une couleur
PIL.Image.show(img)
...
def rotation(px, x, y, t):
    ...
    # cas de base : un pixel tout seul : il tourne sur lui-même et
    # rien ne change...
    # à completer
    pass
