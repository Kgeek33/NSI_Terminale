...
chaine=carte1.recuperer_valeur()+ " de " + carte1.recuperer_couleur()
print(chaine)
assert chaine=="8 de coeur"
carte2 = jeu.recuperer_carte(0)
chaine=carte2.recuperer_valeur()+ " de " + carte2.recuperer_couleur()
print(chaine)
assert chaine=="As de pique"
