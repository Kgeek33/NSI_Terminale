#exo 1
def selection_enclos(tab_animaux, num_enclos):
    selection =[]
    for enregistrement in tab_animaux:
...
def trouver_intrus(tab, g, d):
    ...
    if g == d:
        ...
        if tab[indice]==tab[indice+1]:
            # l'intrus est a droite : on fait bouger g au-delà de indice (+3)
            return trouver_intrus(tab, indice+3, d)
        else:
            # l'intrus est a gauche : on fait bouger d au niveau de indice
