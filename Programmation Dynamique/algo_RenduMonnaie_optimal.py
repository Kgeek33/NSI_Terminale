# Créé le 10/03/2020 en Python 3.4
...
def nb_rendu(pieces,s,prof=""):
    if s == 0 : return 0
    if test_exo2 : print(prof,"nb-rendu(",pieces,s,")")
...
if __name__ == '__main__' and test :
    ...
    # vérifie que le rendu glouton est le meilleur avec les systeme de pièces de l'euro
