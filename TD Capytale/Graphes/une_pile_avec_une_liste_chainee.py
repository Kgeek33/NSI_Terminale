...
def inverser_pile(p):
    ...
    #sans l'instruction suivante, la pile p est vide à force de l'avoir dépilée !
    p.contenu=rev_p
    return rev_p

def pile_inverse(p):
    """prend en argument une pile p et qui renvoie une autre pile avec les éléments empilés dans l’ordre inverse.
...
if __name__ == '__main__' :
    ...
    #P.vider()
    print("lg de la pile =",P.taille())
    print("pile inversée:",str(pile_inverse(P)),"pile d'origine : ",str(P))         #p n'est pas modifiée !!
    print("inversion de pile:",str(inverser_pile(P)),"pile d'origine : ",str(P))    #p est inversée !!
